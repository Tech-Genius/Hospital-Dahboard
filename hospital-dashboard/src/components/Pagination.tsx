...
const Pagination: React.FC = () => {
  ...
  const PageButton: React.FC<{ page: number }> = ({ page }) => {
    ...
    const buttonClass = `w-10 h-8 flex items-center justify-center rounded transition duration-200 text-sm ${
      isCurrent
  ...
  return (
    <div className="flex justify-between items-center bg-surface-dark p-3 rounded-lg mt-4 shadow-xl">
