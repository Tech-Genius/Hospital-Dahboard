...
const FilterPanel: React.FC<FilterPanelProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <RightDrawer isOpen={isOpen} onClose={onClose} widthClass="w-full md:w-130">
            <div className="flex justify-between mt-4 items-center mb-3">
                <div>       <h2 className="text-xl font-bold text-white ">List of counties</h2>
                    <p className='text-[#656565]'>Search filter to apply</p></div>
                <button
                    onClick={onClose}
            ...
            <div className="space-y-6">
                <div className="relative mb-10">
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2 pl-10 pr-4 py-3 rounded-lg bg-[#1F1F1F]   focus:outline-none focus:border-primary-accent text-sm placeholder-text-[#656565]"
                    />
                    ...
                    {mockFilterOptions.country.map(country => (
                        <div key={country} className="flex items-center text-sm">
                            <input
                                ...
                                className="w-4 h-4 text-primary-accent bg-surface-medium border-surface-medium my-2 focus:ring-primary-accent"
                ...
                <div className="space-y-3">
                    ...
                    <select
                        ...
                        className="w-full py-4 px-2 rounded-lg bg-[#1F1F1F]   focus:outline-none focus:border-primary-accent text-sm placeholder-text-[#656565]"
                    >
            ...
            <div className="mt-8 pt-4 border-t border-[#1F1F1F] flex justify-between">
                <button
